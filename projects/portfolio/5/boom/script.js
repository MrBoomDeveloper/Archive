...
const boom = {
	...
	//Deprecated because now you can get it trough npm
	loadDesign: () => {
...
window.addEventListener("error", text => boom.error(text))
window.addEventListener("unhandledrejection", rejection => boom.error(rejection.reason))
